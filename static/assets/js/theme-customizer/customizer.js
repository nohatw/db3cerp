...
$(document).ready(function () {
  $(".customizer-color li").on("click", function () {
    ...
    $("#color").attr(
      "href",
      "/viho/vihoapp/static/assets/css/" + color + ".css"
    );
  ...
  $(".customizer-color.dark li").on("click", function () {
    ...
    console.log("dark button being clicked");
  });
  ...
  $(".sidebar-type li").on("click", function () {
    ...
    switch (type) {
      ...
      case "normal-sidebar": {
        ...
        $(".logo-wrapper")
          .find("img")
          .attr("src", "/viho/vihoapp/static/assets/images/logo/logo.png");
